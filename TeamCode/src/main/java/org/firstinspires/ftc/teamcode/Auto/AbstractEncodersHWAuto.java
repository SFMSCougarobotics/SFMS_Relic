...
import org.firstinspires.ftc.teamcode.Hardware.HardwareAuto;
...
public abstract class AbstractEncodersHWAuto extends LinearOpMode {
    public HardwareAuto robot   = new HardwareAuto();
    ...
    public void goE(double r, double speed, double timeout) {
        ...
        while (opModeIsActive() &&
            ...
            telemetry.addData("Fwd/Bck L/R",  "Running to %7d :%7d", -count, count);
            telemetry.addData("FrntPos",  "Running to %7d :%7d", robot.motorFL.getCurrentPosition(), robot.motorFR.getCurrentPosition());
            telemetry.addData("BackPos",  "Running to %7d :%7d", robot.motorRL.getCurrentPosition(), robot.motorRR.getCurrentPosition());
            telemetry.update();
...
//NOT UPDATED FOR HARDWARE MAP PAST THIS POINT
